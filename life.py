...
if __name__ == '__main__':
    ...
    print('''
        Ура, вы выбрали pygame версию!
        При открытии окна, нажмите:
            SPACE - поставить паузу
            LEFT  - сделать один шаг во время паузы
        ''')
    print('''
        Введите через запятую размер поля,
    ...
    print('''
        ...
        Если да, то введите количество, если не хотите
        ограничивать, то введите 0
    ''')
